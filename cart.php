...
<html>
<head>
<title>Belibliaja - Keranjang Saya</title>
<!-- for-mobile-apps -->
	...
	<div class="agileits_header">
		<div class="container">
			<div class="w3l_offers">
				<p>Belanja Sekarang Dan Nikmati Promo Menariknya!<a href="products.html">BELANJA SEKARANG!</a></p>
			</div>
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>Hubungi Kami : (+62) 123 345 789</li>
				</ul>
			</div>
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">Belibliaja</a></h1>
			</div>
...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h2>Isi keranjangmu ada : <span><?php echo $itungtrans3 ?> barang</span></h2>
			...
			<div class="checkout-left">	
				<div class="checkout-left-basket">
					...
					<ul>
						...
						?>
						<li>Total: + 10k Ongkir)<i> - </i> <span>Rp<?php echo number_format($subtotal) ?></span></li>
					</ul>
				</div>
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Solid Grub, DKI Jakarta.</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:saviordompu@email">saviordompu@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+62 8234 2159</li>
					</ul>
				</div>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2023 Solid Grub. All rights reserved</p>
			</div>
		</div>
